                    ...
                    (function (run) {
                        var Run = (function (_super) {
                            ...
                            function Run(target) {
                                ...
                                _this._btnPause = null;
                                _this._lapTime = null;
                                _this._engineCondition = null;
                                _this._courseMap = null;
                                _this._message = null;
                                _this._pauseWindow = null;
                                _this._players = null;
                                //
                                _this._map = null;
                                _this._physics = null;
                                ...
                                // 停止ボタン
                                _this._btnPause = new run.BtnPause($("#sceneTimeAtackRunBtnPause"));
                                // ラップタイム
                                _this._lapTime = new run.LapTime($("#sceneTimeAtackRunLapTime"));
                                // エンジンメーター
                                _this._engineCondition = new run.EngineCondition($("#sceneTimeAtackRunEngineCondition"));
                                // コースマップ
                                _this._courseMap = new run.coursemap.CourseMap($("#sceneTimeAtackRunCourseMap"));
                                // メッセージ
                                _this._message = new run.Message($("#sceneTimeAtackRunMessage"));
                                // 停止ウィンドウ
                                _this._pauseWindow = new run.pausewindow.PauseWindow($("#sceneTimeAtackRunPauseWindow"));
                                // 走行中プレーヤー
                                _this._players = new run.Players($("#sceneTimeAtackRunPlayers"));
                                //
